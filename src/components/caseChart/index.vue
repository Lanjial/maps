...
export default {
    computed:{
      ...mapState(['relation_between_area_colorlist','data_set_from_json','date_set_from_json','TownName_set_from_json','colorList']),
    },
    data(){
        return{
    ...
    mounted(){
        ...
        // 时间与名称的全局数据处理
        this.$store.commit('timeNameDataHandle',Cases_Number_Monthly);
  ...
  methods:{
    ...
    console.log(this.data_set1_from_json);
